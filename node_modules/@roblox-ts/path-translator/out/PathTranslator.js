...
class PathTranslator {
    constructor(rootDir, outDir, buildInfoOutputPath, declaration, useLuauExtension = false) {
        this.rootDir = rootDir;
        this.outDir = outDir;
        this.buildInfoOutputPath = buildInfoOutputPath;
        this.declaration = declaration;
        this.useLuauExtension = useLuauExtension;
    }
    getLuauExt() {
        return this.useLuauExtension ? constants_1.LUAU_EXT : constants_1.LUA_EXT;
    }
    ...
    getInputPaths(filePath) {
        ...
        const pathInfo = PathInfo.from(filePath);
        if (pathInfo.extsPeek() === this.getLuauExt() && pathInfo.fileName !== constants_1.INDEX_NAME) {
            pathInfo.exts.pop();
